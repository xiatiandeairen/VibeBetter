    ...
    <div className="space-y-6">
      ...
      {!selectedId ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-zinc-700 py-16">
          ...
          <p className="text-sm font-medium text-zinc-400">No decisions yet</p>
          <p className="mt-1 text-xs text-zinc-600">Click &quot;Analyze &amp; Generate&quot; to get AI-driven recommendations</p>
        </div>
      ) : (
